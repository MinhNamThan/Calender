...
public class SearchController implements Initializable {
    ...
    public void searchEvent(){
        if(searchEvent.getText().equals("")){
            ...
            data.clear();
            String sql = "select Title, dateStart, timeStart, Addresses from " + ConvertName.convertEventToSql(kindEnvents.getValue()) + " where Title LIKE '%" + searchEvent.getText() + "%'"
                        + " UNION select Title, dateStart, timeStart, Addresses from " + ConvertName.convertEventToSql(kindEnvents.getValue()) + " where Addresses LIKE '%" + searchEvent.getText() + "%'";
            try {
                pst = con.prepareStatement(sql);
